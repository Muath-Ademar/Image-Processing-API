...
const imageProcessing = (width, height, fileName) => __awaiter(void 0, void 0, void 0, function* () {
    if (!fileName)
    ...
    if (!Number.isNaN(height) && Number.isNaN(width))
        ...
        return Promise.reject(new Error('Missing required parameters: width and height'));
    if (width <= 0 || height <= 0)
