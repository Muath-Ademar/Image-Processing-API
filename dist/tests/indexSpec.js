...
describe('test for api endpoint', () => {
  ...
  describe('tests for api endpoint error handling', () => {
    ...
    it("doesn't get the api endpoint when no file name is entered", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const response = yield request.get(
    ...
    it("doesn't get the api endpoint when the image does not exist in the folder", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const response = yield request.get(
